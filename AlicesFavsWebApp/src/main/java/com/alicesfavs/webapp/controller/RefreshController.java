...
public class RefreshController
{
    ...
    public String refreshSale(@PathVariable String siteId, HttpServletRequest request, ModelMap model, Device device)
    {
    ...
    @RequestMapping(value = "/refresh/new-arrivals/{categoryName}", method = RequestMethod.GET)
    public String refreshNewArrivals(@PathVariable String categoryName, HttpServletRequest request, ModelMap model,
        Device device)
    {
