...
<head>
  ...
  <link rel="shortcut icon" href="/resources/images/favicon-gray.ico" type="image/x-icon" />

  <!-- Retina/iOS favicon -->
  <link rel="apple-touch-icon-precomposed" href="/resources/images/favicon-gray.ico" />
        ...
        <div class="large-12 columns header-container">
          ...
          <div id="logo" class="logo-left">
              <a href="/" title="Alice's Favs" rel="home">
                <img src="/resources/images/logo-gray.jpg" class="header_logo " alt="Alice's Favs"/>
              </a>
          </div><!-- .logo -->
