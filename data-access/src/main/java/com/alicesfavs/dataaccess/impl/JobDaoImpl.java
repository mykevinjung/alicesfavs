...
public class JobDaoImpl implements JobDao
{
            ...
            Integer foundCategoryNo, Integer foundProductNo)
    {
        ...
        { siteId, jobMode.getCode(), jobStatus.getCode(), DateTimeUtils.toTimestamp(startTime),
                DateTimeUtils.toTimestamp(endTime), foundCategoryNo, foundProductNo };
    ...
    public void updateJob(Job job)
    {
        ...
        { job.siteId, job.mode.getCode(), job.status.getCode(), DateTimeUtils.toTimestamp(job.startTime),
                DateTimeUtils.toTimestamp(job.endTime), job.foundCategoryNo, job.foundProductNo, job.id };
    ...
    private class JobRowMapper implements RowMapper<Job>
    {
        public Job mapRow(ResultSet rs, int rowNum) throws SQLException
        {
            ...
            job.foundCategoryNo = rs.getInt("FOUND_CATEGORY_NO");
            job.foundProductNo = rs.getInt("FOUND_PRODUCT_NO");
