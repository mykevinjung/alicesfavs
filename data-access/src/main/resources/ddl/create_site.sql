...
------- additional update
ALTER TABLE SITE ADD COLUMN DEFAULT_ALICE_CATEGORY_ID BIGINT NULL;
ALTER TABLE SITE ADD CONSTRAINT FK_DEFAULT_ALICE_CATEGORY_ID FOREIGN KEY (DEFAULT_ALICE_CATEGORY_ID) REFERENCES ALICE_CATEGORY (ID);
