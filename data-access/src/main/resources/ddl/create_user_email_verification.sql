CREATE SEQUENCE USER_EMAIL_VERIFICATION_ID_SEQ START WITH 1000001;
...
CREATE UNIQUE INDEX USER_EMAIL_VERIFICATION_UNIQUE_IDX ON USER_EMAIL_VERIFICATION (USER_ID);
